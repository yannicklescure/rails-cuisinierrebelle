...
export const navbarBottom = () => {
  ...
  if (userSignedIn) {
    ...
    fetchUserData(init, options).then(data => {
      ...
      navbar += `<a href="/" class="text-dark"><span class="material-icons md-32 d-flex px-3">home</span></a>`;
      navbar += `<a href="/top100" class="text-dark"><span class="material-icons md-32 d-flex px-3">whatshot</span></a>`;
      // navbar += `<a href="" class="text-dark"><span class="material-icons md-32 d-flex px-3">notifications</span></a>`;
      navbar += `<a href="/r/new" class="text-dark"><span class="material-icons md-32 d-flex px-3">add_box</span></a>`;
      navbar += `<a href="/u/${data.user.auth.slug}/bookmarks" class="text-dark"><span class="material-icons md-32 d-flex px-3">bookmarks</span></a>`;
      navbar += `<a href="/u/${data.user.auth.slug}" class="text-dark px-3"><img src="${data.user.auth.image.thumb.url}" width="32" height="32" class="border border-dark rounded-circle"></a>`;
      navbar += `</div>`;
